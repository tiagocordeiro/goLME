...
urlpatterns = [
    ...
    path('summary/variations/', views.json_variations, name='variations'),
    path('summary/variations/<date_from>/<date_to>', views.json_variations, name='variations_with_period'),
